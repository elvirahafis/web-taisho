      ...
      <div class="row">
       <div class="center col-md-6 col-sm-6 col-xs-6 ">
                ...
                <div class="form-group">
                    ...
                    <input id="No_dokumen_masukk" name="No_dokumen_masukk" value="<?php echo $No_dokumen_masuk; ?>"type="hidden" >
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    ...
    function getPurchase() {
        var No_dokumen_masuk=$(No_dokumen_masukk).val();
        console.log(No_dokumen_masuk);
          $.ajax({
            url: "<?php echo site_url(); ?>getPurchaseKode",
            method: 'GET',
            data: {
            ...
            success: function(data) {
                ...
                product.map((data)=>{
                    ...
                    $('#Nama_barang').val(data.Kode_barang);
                    $('#Qty').val(data.Qty);
    ...
    function SubmitProduct(){
      ...
      var No_dokumen_mask=$(No_dokumen_masukk).val();
      ...
      formData.append('No_dokumen_mask', No_dokumen_mask);
      ...
      console.log(formData);
            $.ajax({
            url: "<?php echo site_url(); ?>PurchaseController/UpdatePurchase",
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
