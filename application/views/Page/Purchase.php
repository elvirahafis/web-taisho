  ...
  <?php $this->load->view('layout/navbar'); ?>
   <div class="col-md-12 col-sm-6 col-xs-6" role="main">
    <h3 class="container">List Purchase</h3>
          ...
          <thead>
            <tr>
              ...
              <th scope="col">Harga Beli</th>
               <th scope="col"><a class="btn btn-dark" href="<?= site_url('viewAddPurchase') ?>">Add</a>
            </tr></th>
...
<script type="text/javascript">
    ...
    function getListProduct() {
        $.ajax({
            url: "<?php echo site_url(); ?>getListPurchase",
            method: 'GET',
            success: function(data) {
              console.log(data)
                ...
                while (i < dataproduct.length) {
                  ...
                  datarow +='<tr><td style="width:10%">' + dataproduct[i].No_dokumen_masuk + '</td>' +
                  '<td style="width:10%">' + dataproduct[i].Tanggal_transaksi + '</td>' +
                  '<td style="width:10%">' + dataproduct[i].Nomor_PO + '</td>' +
                  ...
                  '<a type="button" href=" <?= base_url(); ?>UpdatePurchase/' + dataproduct[i].No_dokumen_masuk +'" class="btn btn-primary">Update</a>' +
                  '<button type="button" onClick="DeletePurchase(\'' + dataproduct[i].No_dokumen_masuk + '\')" class="btn btn-dark me-1">Delete</button></td></tr>' 
                   i++;
                }
    ...
    function DeletePurchase(No_dokumen_masuk)
    {
        console.log(No_dokumen_masuk)
             Swal.fire({
                 title: 'Hapus!!',
                 ...
                 if (result.isConfirmed) {
                     ...
                     $.ajax({
                         url: '<?php echo site_url(); ?>PurchaseController/HapusPurchase',
                         method: 'POST',
                         data: formData,
                         processData: false,
                         contentType: false,
